...
test_image images/DrDisRespectLIVE.png 8
test_image images/Emilyispro.png 100
test_image images/summit1g.png 100
test_image images/DreadedCone.png 100
test_image images/Iam_chappie.png 33
test_image images/Chad.png 47
test_image images/BradWOTO.png 100 # This one is all messed up, better to error
